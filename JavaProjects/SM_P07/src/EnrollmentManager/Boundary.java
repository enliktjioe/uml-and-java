        ...
        while(true){
            ...
            switch (choice){
                case 1:
                    ...
                    if(!courseExists)
                        System.out.println("EnrollmentManager.Course created!");
                    else
                        System.out.println("EnrollmentManager.Course already exists!");
                    break;
                case 2:
                    System.out.println("Insert student ID:");
                    boolean studentExists = Controller.registerStudent(scan.nextLine());
                    if(!studentExists)
                        System.out.println("EnrollmentManager.Student registered!");
                    else
                        System.out.println("EnrollmentManager.Student already exists!");
                    break;
                case 3:
                    System.out.println("Insert course title:");
                    ...
                    if(enrolled == 0)
                        System.out.println("EnrollmentManager.Student enrolled in the course!");
                    if(enrolled == -1)
                        System.out.println("EnrollmentManager.Student does not exist!");
                    if(enrolled == -2)
                        System.out.println("EnrollmentManager.Course does not exist!");
                    if(enrolled == -3)
                        System.out.println("EnrollmentManager.Student already enrolled in the course!");
                    if(enrolled == -3)
